  ...
  public TableDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTable = new EntityInsertionAdapter<Table>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `table_tbl` (`id`,`tName`) VALUES (nullif(?, 0),?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Table value) {
        ...
        if (value.getTName() == null) {
          ...
          stmt.bindString(2, value.getTName());
        }
      }
    };
  }
      ...
      public List<Table> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            if (_cursor.isNull(_cursorIndexOfTName)) {
              _tmpTName = null;
            } else {
              _tmpTName = _cursor.getString(_cursorIndexOfTName);
            }
            _item = new Table(_tmpId,_tmpTName);
            _result.add(_item);
          }
          return _result;
        } finally {
